...
<body>
    <div class="container">
        ...
        <form >
            ...
            <input type="text" name="UserName" placeholder="Enter your Username" id='UserName' autofocus>
            ...
            <div class="forgotpss">
                <a href="./sign-in.php">sing-in</a><br> 
            </div>
            <a href="index.php">mesaage</a>
        </form>
